...
## When to Use
Use dochub when you need to query, search, or update the team's local knowledge base. It supports keyword/semantic/hybrid search, RAG-style question answering, and contributor addendums.
